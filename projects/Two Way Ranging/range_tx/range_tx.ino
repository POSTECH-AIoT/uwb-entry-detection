...
void setup()
{
  ...
  spiSelect(PIN_SS);          // select DW3000 peripheral
  ...
  // IDLE_RC to IDLE_PPL
  // Becomes fully active with higher clock frequency (PPL)
  ...
  // PA (Power Amplifier): APlifies weak outgoing signals
  // disable them to save power
